...
public class Utils {
    ...
    public static String getEncodedMail(Context context) {
        SharedPreferences teamId = context.getSharedPreferences(PREF, Context.MODE_PRIVATE);
        return teamId.getString(Constants.KEY_ENCODED_EMAIL, null);
    }
    public static String getProvider(Context context) {
        SharedPreferences teamId = context.getSharedPreferences(PREF, Context.MODE_PRIVATE);
        return teamId.getString(Constants.KEY_PROVIDER, null);
    }
    public static String getGoogleEncodedMail(Context context) {
        SharedPreferences teamId = context.getSharedPreferences(PREF, Context.MODE_PRIVATE);
